...
>(({ className, sideOffset = 4, ...rops }, ref) => (
...
>(({ className, ...rops }, ref) => (
  <DropdownMenuPrimitive.Label ref={ref} className={cn('px-2 py-1.5 text-sm font-semibold', className)} {...rops} />
));
...
>(({ className, ...rops }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={cn('-mx-1 my-1 h-px bg-muted', className)} {...rops} />
));
